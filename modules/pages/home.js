  ...
  function renderHero() {
    ...
    return `
      <section class="cms-hero">
        <div class="cms-kicker">${escape(hero.kicker || "Community CMS")}</div>
        <h1>${escape(hero.title || "A living front page for stories, discussions, events, and members.")}</h1>
        <p>${escape(hero.body || "Curate the newest posts, active forum threads, upcoming events, and community signals from one modular homepage.")}</p>
      </section>
    `;
  }
